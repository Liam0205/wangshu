...
> [../p3-wasm-tier.md](../p3-wasm-tier.md) §5(跨层 trampoline 消费 CallInfo bit50);
...
| 关注点 | P2(本文)拥有 | P3(p3-wasm-tier)拥有 | P4(p4-method-jit)拥有 |
|---|---|---|---|
...
`GibbousCode` 是 P3 编译产物的「安装句柄」,详细定义在 [../p3-wasm-tier.md](../p3-wasm-tier.md) §2.5(待 P3 上线后定稿)。本文只声明 P2 用到的最小形态:

```go
// 引用 [../p3-wasm-tier.md] §2.5(P3 主管定义)
...
- **回收**:Program 销毁时,Bridge 析构清理 `gibbousCodes` map + trampoline 表 + wazero module 关闭。详见 [../p3-wasm-tier.md](../p3-wasm-tier.md) §11(待 P3 落地)。
...
- P4 阶段的 `deopt` 日志详细规约见 [../p4-method-jit.md](../p4-method-jit.md)(P4 主管)。
...
[../p3-wasm-tier.md](../p3-wasm-tier.md)(P3 §2 GibbousCode / §5 trampoline 跨层) ·
[../p4-method-jit.md](../p4-method-jit.md)(P4 §X deopt 反向边 / 状态机扩展) ·
