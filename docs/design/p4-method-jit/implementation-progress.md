...
> P1 全卷(M0-M14)+ P2 PB0-PB7 + 后续优化轮 #1-#4 + P3 PW0-PW10 + VS0-e 全卷已交付(2026-06-16),P4 启动前置就绪;P4 PJ0-PJ11 全部交付(2026-07-01),D2 决议已拍板 (主动保留);**唯一剩余项**是时间窗依赖的 V21 longevity nightly 30 天累积 + V22 30 天累积无 guard 漏判(承 §12 / §13.4),两项非阻塞。P4 amd64 + linux/arm64 + darwin/arm64 三平台端到端已达标。
