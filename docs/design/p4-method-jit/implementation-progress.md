...
| 类目 | 数字 | 来源 |
|---|---|---|
| difftest 三方 byte-equal | **70 用例**(p4Corpus 含 14 SELF spec template 含 3 错误冒泡 + 11 SELF inline + 2 SELF inline 错误冒泡 + 3 PJ4 表 IC 错误冒泡 + 2 PJ3 FORLOOP 错误冒泡 + 2 PJ7 算术错误冒泡 + 36 其他) | test/difftest/p4_test.go |
