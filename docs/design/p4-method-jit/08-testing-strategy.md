...
| V11 | 协程不升层 | 协程内 tier 恒 Interp/Stuck | **+** P4 协程内 P2 tierState 恒非 TierGibbous(承 [../p3-wasm-tier/07-coroutine-thread-rule.md](../p3-wasm-tier/07-coroutine-thread-rule.md) 同款规则,P4 原样继承)|
...
func TestForceAllPromoteRealP4(t *testing.T) {
    ...
    // ② P4 内部子状态断言:P4Speculative(P4 实装内 internal API)
