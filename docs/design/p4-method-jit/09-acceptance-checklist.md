...
- **对 §3.V15a 归档数字的影响**: §3.V15a 单脚本表 nbody 行 (P3 65.08ms / P4 65.65ms / P4/P3 ≈ 0.99x) 是分析器改进**之前**的形态, 之后 P3 65 → 90ms (即 P4 相对 P3 从平手变成显著胜出)。归档数字保留为历史快照, 当前 README perf 表 (f736c92, 2026-07-02) 是**权威现值**。
