...
| V16 | boundary 往返 ≥ P3 wazero 边界 × 0.95 (不慢过 5%) | ✅ 本机 | ⬜ 待跑 | ⬜ 待跑 | P4 边界 ~90 ns 是 P3 ~168 ns 的 0.54x, P4 反而快 1.85x; 本机 amd64 实测; 详 §3.V16。三平台 CI 数据待 bench-acceptance.yml 加 P3 const-body bench 后再跑 |
