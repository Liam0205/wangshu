...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 纯 VM 微基准 [^cat-baseline] | Simple (分支/比较) | 954 ns | 135 ns (**7.07×**) | 4062 ns (0.23×) | 4116 ns (0.23×) | 145 ns (**6.58×**) | 145 ns (**6.58×**) |
| | Arith (Horner) | 1045 ns | 175 ns (**5.97×**) | 10135 ns (0.10×) | 10321 ns (0.10×) | 183 ns (**5.71×**) | 183 ns (**5.71×**) |
| | Loop (求和循环) | 37.2 µs | 17.0 µs (**2.18×**) | 364 µs (0.10×) | 365 µs (0.10×) | 21.4 µs (**1.74×**) | 21.4 µs (**1.74×**) |
| heavy 内核 [^cat-heavy] | HeavyArith | 158 ms | 80.7 ms (**1.96×**) | 91.4 ms (**1.73×**) | 86.9 ms (**1.82×**) | 13.7 ms (**11.52×**) | 13.2 ms (**11.98×**) |
...
| 真实负载 · Call [^cat-embed] | Predicate (×1000) | 476 µs | 583 µs (0.82×) | 572 µs (0.83×) | 589 µs (0.81×) | 588 µs (0.81×) | 568 µs (0.84×) |
| | Transform (×1000) | 337 µs | 436 µs (0.77×) | 444 µs (0.76×) | 438 µs (0.77×) | 471 µs (0.72×) | 442 µs (0.76×) |
| 真实负载 · CallInto [^cat-embed] | Predicate (×1000) | 476 µs | 407 µs (**1.17×**) | 424 µs (**1.12×**) | 425 µs (**1.12×**) | 423 µs (**1.13×**) | 434 µs (**1.10×**) |
