...
| heavy 内核 [^cat-heavy] | HeavyArith | 158 ms | 80.7 ms (**1.96×**) | 86.9 ms (**1.82×**) | 86.9 ms (**1.82×**) | 13.8 ms (**11.45×**) | 13.2 ms (**11.97×**) |
...
| 真实负载 · Call [^cat-embed] | Predicate (×1000) | 476 µs | 583 µs (0.82×) | 569 µs (0.84×) | 589 µs (0.81×) | 561 µs (0.85×) | 560 µs (0.85×) |
| | Transform (×1000) | 337 µs | 436 µs (0.77×) | 436 µs (0.77×) | 438 µs (0.77×) | 431 µs (0.78×) | 435 µs (0.77×) |
| 真实负载 · CallInto [^cat-embed] | Predicate (×1000) | 476 µs | 407 µs (**1.17×**) | 421 µs (**1.13×**) | 425 µs (**1.12×**) | 404 µs (**1.18×**) | 409 µs (**1.16×**) |
