...
P1 has no promotion, so it stays a single column.

Numbers taken on one machine (Intel Xeon Platinum, 24 core, go1.26.2, `-benchtime=2s -count=3`, median, 2026-07-01). Format is "wall time (ratio over gopher-lua)"; larger is better; **bold** marks ratios ≥ 1.5×.
...
| Heavy kernels [^cat-heavy] | HeavyArith | 158 ms | 80.7 ms (**1.96×**) | 91.4 ms (**1.73×**) | 86.9 ms (**1.82×**) | 13.7 ms (**11.52×**) | 13.2 ms (**11.98×**) |
| | HeavyRecursion | 8.16 ms | 5.15 ms (**1.58×**) | 5.75 ms (1.42×) | 5.80 ms (1.41×) | 5.46 ms (1.49×) | 5.41 ms (**1.51×**) |
| | HeavyFloatloop | 285 ms | 147 ms (**1.94×**) | 51.4 ms (**5.55×**) | 51.3 ms (**5.56×**) | 17.3 ms (**16.49×**) | 17.3 ms (**16.51×**) |
| Realworld small [^cat-realworld] | fib | 9.44 ms | 10.0 ms (0.94×) | 25.6 ms (0.37×) | 24.6 ms (0.38×) | 11.2 ms (0.84×) | 11.2 ms (0.85×) |
| | binary-trees | 33.7 ms | 36.8 ms (0.92×) | 105.7 ms (0.32×) | 105.2 ms (0.32×) | 38.4 ms (0.88×) | 38.6 ms (0.87×) |
| | spectral-norm | 22.6 ms | 18.6 ms (1.22×) | 41.1 ms (0.55×) | 47.9 ms (0.47×) | 21.0 ms (1.08×) | 20.6 ms (1.10×) |
| | fannkuch | 4.20 ms | 5.65 ms (0.74×) | 5.83 ms (0.72×) | 5.77 ms (0.73×) | 5.81 ms (0.72×) | 5.82 ms (0.72×) |
| | n-body | 51.9 ms | 45.4 ms (1.14×) | 44.5 ms (1.17×) | 43.8 ms (1.19×) | 43.5 ms (1.19×) | 43.6 ms (1.19×) |
| Boundary mini · Call [^cat-mini] | PureVM | 945 ns | 138 ns (**6.85×**) | — | — | — | — |
| | CallOnly | 85.2 ns | 194 ns (0.44×) | 206 ns (0.41×) | 314 ns (0.27×) | 197 ns (0.43×) | 196 ns (0.43×) |
| | Boundary (+SetGlobal) | 185 ns | 324 ns (0.57×) | 336 ns (0.55×) | 343 ns (0.54×) | 337 ns (0.55×) | 345 ns (0.54×) |
| Boundary mini · CallInto [^cat-mini] | PureVM | 945 ns | 138 ns (**6.85×**) | — | — | — | — |
| | CallOnly | 85.2 ns | 79.4 ns (**1.07×**) | 79.9 ns (**1.07×**) | 181 ns (0.47×) | 79.5 ns (**1.07×**) | 80.7 ns (**1.06×**) |
| | Boundary (+SetGlobal) | 185 ns | 180 ns (1.03×) | 201 ns (0.92×) | 195 ns (0.95×) | 203 ns (0.91×) | 200 ns (0.93×) |
| Realworld embedded · Call [^cat-embed] | Predicate (×1000) | 476 µs | 583 µs (0.82×) | 572 µs (0.83×) | 589 µs (0.81×) | 588 µs (0.81×) | 568 µs (0.84×) |
| | Transform (×1000) | 337 µs | 436 µs (0.77×) | 444 µs (0.76×) | 438 µs (0.77×) | 471 µs (0.72×) | 442 µs (0.76×) |
| Realworld embedded · CallInto [^cat-embed] | Predicate (×1000) | 476 µs | 407 µs (**1.17×**) | 424 µs (**1.12×**) | 425 µs (**1.12×**) | 423 µs (**1.13×**) | 434 µs (**1.10×**) |
| | Transform (×1000) | 337 µs | 287 µs (**1.18×**) | 290 µs (**1.16×**) | 290 µs (**1.16×**) | 301 µs (**1.12×**) | 309 µs (**1.09×**) |
